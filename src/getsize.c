...
"        [-f]                    print letter frequencies\n"
"        [-ft]                   print letter frequencies as latex table\n"
"        [-x]                    translate DNA in six frames\n"
"        [-codons]               print frame0 codon usage (implies -f xlate_dna)\n"
"        [-alph <alphabet file>] use the specified alphabet\n"
"\n"
